...
def loading_mh_info_view():
    """Display the loading MOTHER HUB info view."""
    text1 = "Loading MOTHER"
    text2 = "HUB info..."
    blank_screen()
...
def scanning_networks_view():
    """Display the scanning networks view."""
    if config.data['current_state'] == "link_known_network_successful":
        text1 = "RELOADING"
    else:
        text1 = "SCANNING FOR"
    text2 = "NETWORKS..."
...
def linking_to_mh_view():
    """Display the linking to view."""
    text1 = "LINKING to"
...
def unlinking_from_mh_view():
    """Display the unlinking from MOTHER HUB view."""
    text1 = "UNLINKING..."
    blank_screen()
    draw.text((center_text(text1), 10), text1, font=font, fill=255)
    display_screen()